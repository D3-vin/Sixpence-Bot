"""
Simple menu for Sixpence (based on Teneo style)
...
class SixpenceMenu:
    ...
    def show_welcome(self) -> None:
        ...
        info_panel = Panel(
            ...
            title="[bold blue]Sixpence Community Bot[/bold blue]",
...
_menu_instance: Optional[SixpenceMenu] = None


def get_menu() -> SixpenceMenu:
    """Get global menu instance"""
    global _menu_instance
    if _menu_instance is None:
        _menu_instance = SixpenceMenu()
